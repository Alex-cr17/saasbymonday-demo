...
- MUST treat Drizzle schema and generated SQL migrations as the source of truth for app schema changes
...
- MCP (when configured) MAY be used for post-migration operational checks, but MUST NOT replace Drizzle migration generation/apply flow
